...
export default function OpportunitiesPage({ roles }: { roles: CareerOpening[] }) {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#11122F] text-white">
      ...
      <main>
        <section className="relative min-h-[560px] overflow-hidden pt-32 sm:min-h-[590px]">
          <Image
          ...
          <div className="relative mx-auto flex min-h-[432px] w-[90%] flex-col items-center justify-center text-center sm:min-h-[462px] 2xl:w-[75%]">
