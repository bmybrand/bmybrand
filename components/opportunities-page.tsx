    ...
    <div className="min-h-screen overflow-hidden bg-[#11122F] text-white">
      ...
      <main>
        <section className="relative min-h-[100svh] overflow-hidden pt-32 lg:pt-40">
          ...
          <div className="relative mx-auto flex min-h-[calc(100svh-8rem)] w-[90%] flex-col items-center justify-center pb-16 text-center lg:min-h-[calc(100svh-10rem)] 2xl:w-[75%]">
