...
const projects = [
  ...
  },
  {
    title: (
      <>
        <span className="text-[#00ACC8]">Instinctive Healthcare Solutions</span>
      </>
    ),
    description: "Placeholder description for Instinctive Healthcare Solutions.",
    buttonText: "View Full Case Study",
    src: "/bmyb-case-instinctive-healthcare-slider-01.webp",
    link: "/case-studies/instinctive-healthcare-solutions",
    logo: "",
    gradient: "linear-gradient(180deg, #00ACC8 0%, #004D59 100%)",
    buttonColor: "#00ACC8",
  ...
  },
  {
    title: (
      <>
        <span className="text-[#ED3041]">Instinctive Health</span>
      </>
    ),
    description: "Placeholder description for Instinctive Health.",
    buttonText: "View Full Case Study",
    src: "/bmyb-case-instinctive-health-slider-01.webp",
    link: "/case-studies/instinctive-health",
    logo: "",
    gradient: "linear-gradient(180deg, #ED3041 0%, #6E161E 100%)",
    buttonColor: "#ED3041",
    buttonIcon: "/bmyb-global-arrowred-01.svg",
    backgroundImage: "",
  },
  {
    title: (
      <>
        <span className="text-[#F45334]">learnandlabel</span>
      </>
    ),
    description: "Placeholder description for learnandlabel.",
    buttonText: "View Full Case Study",
    src: "/bmyb-global-fullimage-01.webp",
    link: "/case-studies/learnandlabel",
    logo: "",
    gradient: "linear-gradient(135deg, #9AB821 0%, #E9B10F 33%, #F45334 66%, #E07D32 100%)",
    buttonColor: "#F45334",
    buttonIcon: "/bmyb-global-arrowred-01.svg",
    backgroundImage: "",
  },
  {
    title: (
      <>
        <span className="text-[#EBA421]">Vytis Tour</span>
      </>
    ),
    ...
    logo: "",
    gradient: "linear-gradient(180deg, #EBA421 0%, #7A5511 100%)",
    buttonColor: "#EBA421",
    buttonIcon: "/bmyb-global-arrowyellow-01.svg",
    backgroundImage: "",
  },
