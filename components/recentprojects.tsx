...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'We created a clearer, healthcare-focused digital experience for Instinctive Healthcare Solutions that improves trust, simplifies navigation, and supports faster access to critical service information.',
  ...
  },
  {
    ...
    description: 'We shaped a streamlined membership-driven healthcare platform for Instinctive Health that makes benefits, care access, and cost clarity easier for users to understand at a glance.',
  ...
  },
  {
    ...
    description: 'We built a practical, teacher-friendly digital experience for Learn and Label focused on saving time, simplifying classroom workflows, and making everyday tasks easier to manage.',
  ...
  },
  {
    ...
    number: '07',
    title: 'VYTIS TOUR',
    description: 'We designed a travel-first digital platform for Vytis Tour that turns destination browsing into a smoother, more inspiring journey built to drive inquiries and bookings.',
  ...
  },
  {
    ...
    number: '08',
    title: 'JERSEY',
    description: 'We created an energetic community-focused experience for Jersey that helps players discover matches, join events, and stay connected through a more organized digital hub.',
  ...
  },
  {
    ...
    number: '09',
    title: 'BHS',
    description: 'We developed a more mission-led digital presence for BHS that supports community outreach, strengthens credibility, and communicates housing-focused support with greater clarity.',
