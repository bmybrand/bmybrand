...
export default function BrandExperienceBento() {
  ...
  return (
    <div ref={bentoGridRef} className="grid auto-rows-[6.4rem] gap-4 md:grid-cols-12 md:auto-rows-[6.4rem]">
      <div className="group relative overflow-hidden rounded-[0.9rem] border border-white/10 bg-[#1C1D3D] px-7 py-5 md:col-span-5 md:row-span-4">
        ...
        <div className="relative z-20 flex h-full flex-col pb-32">
          <div className="flex items-center justify-between gap-3">
            ...
            />
            <div className="inline-flex items-center rounded-full border border-white/25 bg-transparent p-1.5 text-[0.62rem] text-white/78">
              <button
                type="button"
      ...
      >
        ...
        {isImageEdgeStory ? (
          <>
            <img src={activeEdgeStoryImage} alt="" className="absolute inset-0 h-full w-full object-cover" />
        ...
        <div className="relative z-20 flex h-full flex-col pb-24">
                ...
                {physicsReady ? (
                  <Gravity gravity={{ x: 0, y: 1 }} draggable={true} className="h-[calc(100%_-_0.35rem)] w-full px-4 py-2">
                    <MatterBody matterBodyOptions={{ friction: 0.5, restitution: 0.2 }} x="12%" y="2%" angle={-70}>
                      <div className="inline-flex select-none items-center justify-center whitespace-nowrap rounded-full border border-[#FF5A2F] bg-transparent px-[22px] py-[10px] text-[14px] leading-none text-white">
                        Brand Strategy
                      </div>
                    </MatterBody>
          ...
          <div className="absolute -bottom-3 left-0 right-0 flex items-center gap-3 pb-6 pt-2 sm:-bottom-4">
            <input
              ...
              className="flex-1 rounded-full border border-white/55 bg-transparent px-4 py-3 text-[11px] text-white outline-none transition-colors placeholder:text-white/55 focus:border-white/80"
            />
            <button type="button" aria-label="Like" className="flex h-10 w-10 items-center justify-center">
              <img
      ...
      <div className="relative overflow-hidden rounded-[0.9rem] border border-white/10 bg-[#1C1D3D] p-5 md:col-span-8 md:row-span-1">
        ...
        <div className="relative z-10 flex h-full items-center justify-between gap-6 px-2">
          <div className="text-[24px] leading-none text-white BenzinSemibold">Benzin</div>
          <div
      ...
      <div className="relative overflow-hidden rounded-[1rem] border border-white/10 bg-[#1C1D3D] p-6 md:col-span-3 md:row-span-3">
        ...
        <div className="relative z-10 flex h-full flex-col">
          <div className="mb-0 pb-0 text-center text-[1.15rem] text-white/92 BenzinSemibold">
            Notification Center
          </div>
          <div className="relative mt-0 flex flex-1 items-center justify-center pb-0 pt-0">
            <motion.div
            ...
            <motion.div
              className="relative ml-[1.8rem] flex w-[18rem] max-w-none shrink-0 items-center gap-3 rounded-l-[1.1rem] bg-[#E9E6E8]/70 px-6 py-6 shadow-[0_22px_44px_rgba(10,12,30,0.28)]"
              style={{ top: '-0.9rem' }}
            ...
            >
              ...
              <div className="min-w-0">
                <div className="text-[18px] leading-none text-[#1A1A2C] BenzinSemibold">Bmybrand</div>
      ...
      <div className="relative overflow-hidden rounded-[0.9rem] border border-white/10 bg-[#1C1D3D] md:col-span-5 md:row-span-3">
        <img src="/bmyb-tech-logodimen-01.svg" alt="" className="h-full w-full object-cover" />
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.04),transparent)]" />
      </div>

      <div className="group relative flex items-center justify-center overflow-hidden rounded-[0.9rem] border border-white/10 bg-[#1C1D3D] p-5 md:col-span-4 md:row-span-3">
        <img
          src="/bmyb-tech-bentologobox-01.svg"
          alt="Brand workflow icons"
          width={640}
          height={420}
          className="relative z-10 max-h-full max-w-full object-contain transition-all duration-300 ease-out group-hover:scale-[1.04] group-hover:drop-shadow-[0_0_26px_rgba(244,91,37,0.5)]"
        />
