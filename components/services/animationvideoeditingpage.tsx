    ...
    <div className="bg-[#11122F] text-white">
      ...
      <section className="relative min-h-screen overflow-hidden pt-32">
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100vh-8rem)] w-[90%] flex-col justify-center pb-16 2xl:w-[75%]">
          <div className="max-w-5xl">
            ...
            <Link
              href="/strategy-call"
              className="BenzinSemibold mt-12 flex w-fit items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-[#F45B25] to-[#FF843E] px-2 py-2 text-sm text-white whitespace-nowrap transition-all duration-300 hover:-translate-y-1 hover:brightness-105 hover:shadow-[0_0_25px_rgba(244,91,37,0.5)] sm:text-[14px] md:text-[15px] lg:text-[15px] xl:text-[15px] 2xl:text-base"
            >
      ...
      <section className="px-6 py-20">
        <div className="mx-auto w-[90%] rounded-lg border border-[#F45B25]/25 bg-[#11122F] p-8 text-center md:p-12 2xl:w-[75%]">
          ...
          <Link
            href="/strategy-call"
            className="BenzinSemibold mx-auto mt-8 flex w-fit items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-[#F45B25] to-[#FF843E] px-2 py-2 text-sm text-white whitespace-nowrap transition-all duration-300 hover:-translate-y-1 hover:brightness-105 hover:shadow-[0_0_25px_rgba(244,91,37,0.5)] sm:text-[14px] md:text-[15px] lg:text-[15px] xl:text-[15px] 2xl:text-base"
          >
            <div className="rounded-lg bg-white p-4">
              <svg
                width="15"
