            ...
            <div className={`flex-1 z-10 ${compact ? 'p-8 md:p-10 lg:p-12' : 'p-8 md:p-12 lg:p-16'}`}>
              ...
              >
                <button
                  ...
                  className="px-8 py-4 bg-linear-to-r from-[#F45B25] to-[#FF843E] text-white rounded-lg BenzinSemibold hover:-translate-y-1 hover:shadow-[0_0_25px_rgba(244,91,37,0.5)] hover:brightness-105 transition-all duration-300 flex items-center justify-center gap-2"
                >
