          ...
          <div className="flex-1 min-w-0">
            ...
            <form className="flex flex-col gap-4 w-full" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="w-full">
                <button
                  type="submit"
                  className="w-full h-12 rounded-lg bg-linear-to-r from-[#F45B25] to-[#FF843E] text-white font-semibold hover:-translate-y-1 hover:shadow-[0_0_25px_rgba(244,91,37,0.5)] hover:brightness-105 transition-all duration-300 BenzinSemibold"
                >
                  Send Message
                </button>
              </div>
