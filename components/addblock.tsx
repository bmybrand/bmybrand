    ...
    <section className='bg-[#11122F] pt-30'>
      <div className='mx-auto w-[90%] 2xl:w-[75%] h-fit rounded-xl relative '>
        <Image
          ...
          className='absolute bottom-0 right-0 w-40 md:w-48 lg:w-[40%] lg:block hidden h-auto z-20 object-contain lg:scale-105 xl:scale-110 2xl:scale-120 animate-bounceRocket -rotate-5'
        />
