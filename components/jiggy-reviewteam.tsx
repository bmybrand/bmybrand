  ...
  const reviews: Review[] = [
    {
      ...
      testimonial:
        'BMYBrand took our personality and turned it into a website that feels just as bold as the product. The layout makes it easy for customers to understand what Jiggy Jerky is about and move quickly toward buying.',
    },
    {
      id: 2,
      name: 'Operations Team',
      position: 'Fulfillment & Sales',
      image: 'https://i.pravatar.cc/150?img=5',
      testimonial:
        'The new site makes product discovery and shopping much smoother. It is easier to manage the customer journey, and the brand presentation feels far more polished and premium.',
    },
    {
      id: 3,
      name: 'Customer Feedback',
      position: 'Direct-to-Consumer Audience',
      image: 'https://i.pravatar.cc/150?img=8',
      testimonial:
        'The site now feels like a real extension of the brand: fun, bold, and delicious-looking. It gives customers a better reason to stay, browse, and shop.',
    },
  ]
          ...
          <div className="lg:col-span-5">
            ...
            >
              ...
              <p className="text-white/60 text-sm md:text-base mb-8 max-w-md">
                We partnered closely with the Jiggy Jerky team to deliver a bold e-commerce experience. Here is their feedback on the final outcome.
              </p>
...
export default JiggyReviewTeam
