...
const secondaryCareerButtonClass =
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg border border-white px-2 py-2 text-sm text-white transition-all duration-300 hover:-translate-y-1 hover:bg-white/10 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] sm:text-[14px] md:text-[15px] lg:text-[15px] xl:text-[15px] 2xl:text-base'
