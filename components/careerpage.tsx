          ...
          <div className="mx-auto w-[90%] 2xl:w-[75%]">
            ...
            <div className="relative mt-20 pt-12">
              ...
              >
                ...
                <path d="M610 335 V344 Q610 364 630 364 H700" fill="none" stroke="rgba(255,255,255,.28)" strokeWidth="1.5" strokeDasharray="5 7" markerEnd="url(#hire-arrow)" />
                <path d="M916 38 V35 Q916 25 926 25 H975" fill="none" stroke="rgba(255,255,255,.28)" strokeWidth="1.5" strokeDasharray="5 7" markerEnd="url(#hire-arrow)" />
                <path d="M916 357 V362 Q916 372 926 372 H960" fill="none" stroke="rgba(255,255,255,.28)" strokeWidth="1.5" strokeDasharray="5 7" markerEnd="url(#hire-arrow)" />
              </svg>
              ...
              <div className="relative grid items-center gap-x-4 gap-y-20 md:grid-cols-2 xl:grid-cols-[1fr_1fr_2.05fr_1fr_.92fr]">
                ...
                <article className="relative min-h-[270px] rounded-[1.75rem] border border-white/18 bg-[#151632] px-6 pb-8 pt-20 text-center xl:translate-y-4">
