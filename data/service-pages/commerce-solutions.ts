...
export const commerceSolutionsServiceData: ServicePageData = {
  ...
  heroList: [
    ...
    { title: 'WooCommerce Stores Development' },
  ...
  overviewItems: [
    {
      number: '1',
      title: 'E-Commerce Automation',
      desc: 'Our automation specialists streamline workflows that improve efficiency, accuracy, and customer satisfaction.',
    },
    {
      number: '2',
      title: 'Magento Store Development',
    ...
    },
    {
      ...
      desc: 'Our platform experts create Shopify and WooCommerce stores optimized for sales and customer engagement.',
    },
    {
      number: '4',
      title: 'Payment Gateway Integration',
      desc: 'Our integration specialists implement secure payment gateways that ensure smooth and reliable transactions.',
    },
    {
      number: '5',
      title: 'Marketplace Development',
      desc: 'Our marketplace developers build multi-vendor platforms designed for seamless buying and selling experiences.',
    },
  ],
