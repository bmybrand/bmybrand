...
export const travelAndTourismIndustry: IndustryItem = {
  ...
  projects: [
    {
      brand: 'VYTIS TOUR',
      brandLogo: '/bmyb-case-vytis-tour-logo-01.svg',
      title: 'Booking-Ready Experience Design',
      tag: 'Travel and Tourism',
      href: '/case-studies/vytis-tour',
