...
export const sharedIndustryServicesTitle = 'Our Complete Digital Solutions for Every Industry'

export const sharedIndustryServicesDescription =
...
export const sharedIndustryServices: IndustryService[] = [
  {
